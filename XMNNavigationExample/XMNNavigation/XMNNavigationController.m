...
#pragma mark - UIViewController (XMNNavigation)

@implementation UIViewController (XMNNavigation)


#pragma mark - UIViewController (XMNNavigation) Method

- (void)xmn_pushViewController:(UIViewController * __nonnull)viewController {
    
    [self xmn_pushViewController:viewController
                          params:nil
...
- (UIViewController * __nullable)xmn_popViewController {
    ...
    return [self xmn_popViewController:nil];
}
...
- (NSArray<UIViewController *> * __nullable)xmn_popToViewController:(UIViewController * __nonnull)viewController {
   ...
   return [self xmn_popToViewController:viewController
                  completionBlock:nil];
}
...
- (NSArray<UIViewController *> * __nullable)xmn_popToRootViewController {
    ...
    return [self xmn_popToRootViewController:nil];
}
...
- (NSArray<UIViewController *> * __nullable)xmn_popToRootViewController:(void(^ __nullable)(BOOL finished))completionBlock {
    ...
    if (self.xmn_navigationController) {
        ...
        return [self.xmn_navigationController xmn_popToRootViewController:completionBlock];
    }else {
...
#pragma mark - UIViewController (XMNNavigation) Setter
...
#pragma mark - UIViewController (XMNNavigation) Getter
